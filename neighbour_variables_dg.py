...
def get_neighbour_variables(snap_dir, snap_number):
    ...
    #get host group
    host_groups = cu.get_host_groups(snap_dir1, snap_number, 0)
    ...
    return central_pos, adj_pos, adj_masses, adj_densities, adj_vels, adj_Ts
...
for i in range(54,56):  
    central_pos, adj_pos, adj_masses, adj_densities, adj_vels, adj_Ts = get_neighbour_variables(snap_dir1, i)
...
np.savez('neighbour_variables_dg.npz', positions=positions, masses=masses, densities=densities, velocities=velocities, temps=temps)